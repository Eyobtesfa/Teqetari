using TeqetariApi.Application.Validators.Create.Employer;
using FluentValidation;
using TeqetariApi.Application.DTOs.Create.Employer;

namespace TeqetariApi.Application.Validators.Create.Employer;

public class HouseholdEmployerValidator : AbstractValidator<CreateHouseholdEmployerDto>
{
